...
highcut = 3000.0        # (Hz), high cutoff frequency for bandpass filter
filterOrder = 3
signalEnvelope = True
signalOnset = True
DCoffsetRemoved = True
signalNormalize = True
signalUnitized = False
...
#    print("mean A = ",np.mean(fft1)," std = ",np.std(fft1))
#    print("mean E = ",np.mean(fft2)," std = ",np.std(fft2))
#    print("mean C = ",np.mean(fft3)," std = ",np.std(fft3))
#    print("mean G = ",np.mean(fft4)," std = ",np.std(fft4))
#    
#    np.savetxt(f1, fft1, delimiter=",")
#    np.savetxt(f2, fft2, delimiter=",")
#    np.savetxt(f3, fft3, delimiter=",")
#    np.savetxt(f4, fft4, delimiter=",")
